...
import { COLLEGES, DISTRICTS, BRANCHES } from "@/lib/mock-data";
import { Search, Filter, MapPin, Building2, ArrowRight, X } from "lucide-react";
...
function Explorer() {
  ...
  }, [q, district, type, naac, nba, branch, hostel, maxFees, minPlacement]);
        ...
        <aside className="space-y-6 lg:sticky lg:top-20 lg:self-start">
          <Card className="p-5 rounded-2xl">
            ...
            <div className="space-y-4">
              ...
              <FilterSelect label="College type" value={type} onChange={setType} options={["Government", "Government Aided", "Self-Financing", "University Dept."]} />
        ...
        <div>
          <div className="flex items-center justify-between mb-5">
            <div className="text-sm text-muted-foreground">
              Showing <span className="font-semibold text-foreground">{results.length}</span> of {COLLEGES.length} colleges
            </div>
          </div>

          {results.length === 0 ? (
            <Card className="p-10 rounded-2xl text-center">
              <div className="text-muted-foreground">No colleges match your filters.</div>
                  ...
                  <div className="flex flex-col md:flex-row md:items-start gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1.5">
                        ...
                        {c.nba && <Badge variant="outline">NBA</Badge>}
                      </div>
                    ...
                    <Link to="/colleges/$code" params={{ code: c.code }} className="shrink-0">
                      <Button className="rounded-xl gap-1">Details <ArrowRight className="size-3.5" /></Button>
                    </Link>
                  </div>
                </Card>
              ))}
